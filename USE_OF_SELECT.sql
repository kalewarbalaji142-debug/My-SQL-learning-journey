...
-- SELECT * FROM users WHERE gender!= 'Female'
-- SELECT * FROM users WHERE gender<> 'Female'
-- SELECT * FROM users WHERE date_of_birth BETWEEN '1989-01-01' AND '1990-01-01';
...
-- SELECT * FROM users WHERE gender='Male' OR salary>'60000' ORDER BY date_of_birth DESC LIMIT 10;
-- SELECT * FROM users WHERE salary > 60000 ORDER BY created_at DESC LIMIT 5
-- SELECT * FROM users ORDER BY salary DESC;
-- SELECT * FROM users ORDER BY salary ASC;
-- SELECT * FROM users WHERE salary NOT BETWEEN 50000 AND 70000
