...
-- ____________________UPDATING DATABASE USING UPDATE QUERY ________________________

USE startersql;
-- UPDATE users SET salary = 40000 WHERE id=2;
-- UPDATE users SET email='aarya@gmail.com' WHERE id=2;
-- UPDATE users SET salary =70000  WHERE id=5;
-- UPDATE users SET name= 'Aisha Khan'  WHERE email= 'aisha@example.com';
-- UPDATE users SET salary=salary+10000  WHERE salary<60000;
/*UPDATE users 
SET salary = salary + 10000  
WHERE salary < 60000 AND id > 0;
*/
-- SELECT * FROM users;

-- _______________________DELETING DATA FROM DATABASE______________________


-- DELETE FROM users WHERE salary > 80000 AND id > 0;
-- DELETE FROM users where id=2;
-- UPDATE users SET id = id - 25 WHERE id > 0;
